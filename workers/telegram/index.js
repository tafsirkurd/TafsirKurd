export default {
  async fetch(request, env) {
    ...
    if (request.method !== 'POST') return new Response('TafsirKurd Telegram Bot OK', { status: 200 });
