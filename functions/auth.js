...
// Original: netlify/functions/auth.js
...
export async function onRequest(context) {
    ...
    const requestOrigin = Object.fromEntries(request.headers).origin || Object.fromEntries(request.headers).referer;
    ...
    if (await checkRateLimit(clientIP, 20, 60000)) {
    ...
    if (await request.text() && !validateBodySize(await request.text(), 10)) {
