...
// Original: netlify/functions/geo-analytics.js
...
function getClientIP(event) {
    ...
    const clientIP = Object.fromEntries(request.headers)['x-nf-client-connection-ip'] ||
        ...
        if (request.method === 'POST') {
            ...
            const { error: insertError } = await supabase
                ...
                .insert({
                    ...
                    user_agent: Object.fromEntries(request.headers)['user-agent'] || 'Unknown',
