    ...
    function injectFooterAppSection() {
        ...
        if (!document.getElementById('tk-promo-css')) {
            ...
            st.textContent = [
                ...
                '[data-theme="light"]  .tk-fa-brand img{filter:brightness(0) invert(1)!important}',
                '[data-theme="dark"]   .tk-fa-brand img{filter:brightness(0) invert(1)!important}',
                '[data-theme="noor"]   .tk-fa-brand img{filter:none!important}',
                '[data-theme="sakina"] .tk-fa-brand img{filter:brightness(0) saturate(100%) invert(68%) sepia(31%) saturate(860%) hue-rotate(8deg) brightness(94%)!important}',
