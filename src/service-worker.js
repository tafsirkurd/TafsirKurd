const CACHE_NAME = 'tafsir-kurd-v118-mobile-50px';
const urlsToCache = [
  '/',
  '/index.html',
  '/Quran.html',
...
self.addEventListener('install', event => {
  console.log('[ServiceWorker] Installing v118-mobile-50px - Increased mobile top spacing to 50px when scrolling down');
  event.waitUntil(
