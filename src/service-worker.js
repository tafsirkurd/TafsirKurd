const CACHE_NAME = 'tafsir-kurd-v117-mobile-35px';
const urlsToCache = [
  '/',
  '/index.html',
  '/Quran.html',
...
self.addEventListener('install', event => {
  console.log('[ServiceWorker] Installing v117-mobile-35px - Increased mobile top spacing to 35px when scrolling down');
  event.waitUntil(
